...
<template>
  <main class="overflow-hidden">
    <!-- Hero Section -->
    <div class="relative bg-white pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      <!-- Decoratives -->
      <div class="absolute top-0 right-0 -mr-20 -mt-20 w-[600px] h-[600px] bg-indigo-50 rounded-full blur-3xl opacity-50 z-0 pointer-events-none"></div>
      <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-[400px] h-[400px] bg-sky-50 rounded-full blur-3xl opacity-50 z-0 pointer-events-none"></div>

      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 flex flex-col md:flex-row items-center gap-12">
        <!-- Text Content -->
        <div class="flex-1 text-center md:text-left">
          <div class="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 px-4 py-2 rounded-full font-semibold text-sm mb-6">
        ...
        <div class="flex-1 w-full max-w-[500px] md:max-w-none relative">
            <div class="aspect-square rounded-3xl overflow-hidden shadow-2xl ring-1 ring-gray-100 rotate-2 hover:rotate-0 transition-transform duration-700">
                <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1000&q=80" alt="Hero Product" class="w-full h-full object-cover">
            </div>
             <!-- Floating Badge -->
            <div class="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-gray-50 flex items-center gap-4 bounce-slow">
